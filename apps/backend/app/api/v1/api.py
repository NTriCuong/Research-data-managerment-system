...
from app.api.v1.endpoints import backup, auth, core_approve, core_repository, imports, logs, notifications, public_research, reference, reports, search, staging_metadata, staging_review, users
...
api_router.include_router(public_research.router, prefix="/public", tags=["Public Research"])
