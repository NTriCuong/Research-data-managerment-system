...
import { approverService } from '@/services/approver/approver.service'
...
import type { PendingApproval } from '@/services/approver/approver.service'
...
export default function ApprovalResearches() {
    const router = useRouter()
    const [dataResearch, setDataResearch] = useState<PendingApproval[]>([])
    ...
    useEffect(() => {
        const fetchResearchData = async () => {
            ...
            try {
                const data = await approverService.getPendingApprovals()
