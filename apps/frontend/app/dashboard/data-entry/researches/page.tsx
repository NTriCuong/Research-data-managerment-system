...
export default function Researches() {
    ...
    }, [accessFilter, dataResearch, departmentFilter, outputTypeFilter, search, statusFilter, yearFilter])
    ...
    return (
        <div className="space-y-6 p-6">
            <div className="flex flex-wrap items-end justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-semibold text-gray-900">Nghiên cứu của tôi</h1>
                    <p className="mt-1 text-sm text-gray-500">
                        {dataResearch.length} bài nghiên cứu
                    </p>
                </div>
                        ...
                        <TableBody>
                            ...
                            {!loading && filteredData.map((item) => (
                                ...
                                >
                                    ...
                                    <TableCell className="px-4 py-3 text-gray-600">{item.update_reason ?? '-'}</TableCell>
                                    <TableCell className="px-4 py-3 text-gray-600">{item.metadata_quality_score ?? '-'}</TableCell>
                                    <TableCell className="px-4 py-3 text-gray-600">{formatDateTime(item.created_at)}</TableCell>
                                    <TableCell className="px-4 py-3 text-gray-600">{formatDateTime(item.updated_at)}</TableCell>
                                </TableRow>
                            ))}
