                            ...
                            <div className="flex items-center justify-between border-b border-gray-100 px-4 py-2">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`rounded-full px-2 py-0.5 text-xs ${activeTab === "all" ? "bg-[#1f3568] text-white" : "text-gray-500 hover:text-[#1f3568]"}`}
                                    >
                                        Tất cả
                                    </button>
                                    <button
                                        ...
                                        className={`rounded-full px-2 py-0.5 text-xs ${activeTab === "unread" ? "bg-[#1f3568] text-white" : "text-gray-500 hover:text-[#1f3568]"}`}
                                    >
                                        Chưa xem
                                    </button>
                                </div>
